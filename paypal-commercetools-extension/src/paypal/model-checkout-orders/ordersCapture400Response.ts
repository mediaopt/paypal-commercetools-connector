...
export class OrdersCapture400Response {
  'name'?: OrdersCapture400Response.NameEnum;
  'message'?: OrdersCapture400Response.MessageEnum;
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: 'name',
      baseName: 'name',
      type: 'OrdersCapture400Response.NameEnum',
    },
    {
      name: 'message',
      baseName: 'message',
      type: 'OrdersCapture400Response.MessageEnum',
    },
    {
      name: 'issues',
      baseName: 'issues',
  ...
  static getAttributeTypeMap() {
    return OrdersCapture400Response.attributeTypeMap;
  }
}

export namespace OrdersCapture400Response {
