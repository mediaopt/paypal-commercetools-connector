...
export class ShipmentTracker {
   ...
   */
  'shipmentDirection'?: ShipmentTracker.ShipmentDirectionEnum;
  /**
   * To denote which party uploaded the shipment tracking info.
   */
  'shipmentUploader'?: ShipmentTracker.ShipmentUploaderEnum;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      type: 'ShipmentTracker.ShipmentDirectionEnum',
    },
    {
      name: 'shipmentUploader',
      baseName: 'shipment_uploader',
      type: 'ShipmentTracker.ShipmentUploaderEnum',
    },
  ];

  static getAttributeTypeMap() {
    return ShipmentTracker.attributeTypeMap;
  }
}

export namespace ShipmentTracker {
